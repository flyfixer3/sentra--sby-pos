            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">Update Entity <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="form-row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" required value="{{ old('name', $entity->name) }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="code">Entity Code <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="code" required value="{{ old('code', $entity->code) }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mt-lg-4 pt-lg-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" {{ old('is_active', $entity->is_active) ? 'checked' : '' }}>
                                            <label class="custom-control-label" for="is_active">Active Entity</label>
                                        </div>
                                        <small class="form-text text-muted">Matikan hanya jika entity ini tidak boleh dipakai untuk branch baru.</small>
                                    </div>
                                </div>
                            </div>
                        </div>

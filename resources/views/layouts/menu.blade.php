...
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('products.*') || request()->routeIs('product-categories.*') ? 'c-show' : '' }}">
    ...
    <ul class="c-sidebar-nav-dropdown-items">
        @can('access_product_accessories')
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('product-accessories.*') ? 'c-active' : '' }}" href="{{ route('product-accessories.index') }}">
                <i class="c-sidebar-nav-icon bi bi-collection" style="line-height: 1;"></i> Accessories
            </a>
        </li>
        @endcan
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('product-warehouses.*') ? 'c-active' : '' }}" href="{{ route('product-warehouses.index') }}">
                <i class="c-sidebar-nav-icon bi bi-collection" style="line-height: 1;"></i> Warehouses
            </a>
        </li>
        @endcan

        {{-- HAPUS blok inventory lama yang salah eja & rutenya tidak ada
        @can('access_invetories')
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('invetories.*') ? 'c-active' : '' }}" href="{{ route('inventory.index') }}">
                <i class="c-sidebar-nav-icon bi bi-collection" style="line-height: 1;"></i> Inventory
            </a>
        </li>
        @endcan
        --}}
...
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->is('inventory*') || request()->routeIs('inventory.*') ? 'c-show' : '' }}">
    ...
    <ul class="c-sidebar-nav-dropdown-items">
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('inventory.stocks.index') ? 'c-active' : '' }}" href="{{ route('inventory.stocks.index') }}">
...
{{-- =========================
    MUTATIONS
========================= --}}
@can('access_mutations')
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('mutations.*') ? 'c-show' : '' }}">
    <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
...
{{-- =========================
    PURCHASE ORDERS
========================= --}}
@can('access_purchase-orders')
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('purchase-orders.*') ? 'c-show' : '' }}">
    <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
        <i class="c-sidebar-nav-icon bi bi-cart-check" style="line-height: 1;"></i> Purchase Orders
    </a>
    <ul class="c-sidebar-nav-dropdown-items">
        @can('create_purchase-orders')
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('purchase-orders.create') ? 'c-active' : '' }}" href="{{ route('purchase-orders.create') }}">
                <i class="c-sidebar-nav-icon bi bi-journal-plus" style="line-height: 1;"></i> Create PO
            </a>
        </li>
        @endcan
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('purchase-orders.index') ? 'c-active' : '' }}" href="{{ route('purchase-orders.index') }}">

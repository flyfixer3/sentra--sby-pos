...
{
    /**
     * Tambahkan kolom agregat 'stock_on_hand' (sum qty_total) untuk cabang aktif.
     * Pemakaian:
    ...
    public function scopeWithBranchStock(Builder $query, ?int $branchId = null): Builder
    {
        ...
        // Nama relasi: stockRacks. Kolom qty: qty_total (sesuaikan kalau di schema kamu pakai 'qty')

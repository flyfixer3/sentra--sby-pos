    ...
    <div class="dropdown-menu">
        ...
        @if(!empty($data->deleted_at))
            ...
            @can('delete_purchases')
                <button class="dropdown-item" type="button" data-confirm-target-form="restore{{ $data->id }}" data-confirm-title="Confirm Restore" data-confirm-message="Restore this Purchase?" data-confirm-button="Restore" data-confirm-variant="success">
        ...
        @else
            ...
            @can('delete_purchases')
                <button class="dropdown-item" type="button" data-confirm-target-form="destroy{{ $data->id }}" data-confirm-title="Confirm Delete" data-confirm-message="Soft delete this Purchase Invoice? This is only allowed if it has no payments and no processed receiving." data-confirm-button="Delete" data-confirm-variant="danger">

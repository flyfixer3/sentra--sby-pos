...
@section('content')
    <div class="container-fluid mb-4">
        <div class="row">
            <div class="col-12">
                <livewire:search-product :warehouseId="($stock_mode ?? 'branch_all') === 'warehouse' ? ($loadingWarehouseId ?? null) : null"/>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="purchase-form" action="{{ route('purchases.update', $purchase) }}" method="POST"
                              ...
                              data-confirm-title="Confirm Purchase Update?"
                              data-confirm-message="Please review the purchase changes carefully before updating. This action may affect inventory and accounting records."

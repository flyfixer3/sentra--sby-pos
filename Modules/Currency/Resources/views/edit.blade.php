...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('currencies.update', $currency) }}" method="POST"
              ...
              data-confirm-message="Please make sure all changes are correct before updating this currency."
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="decimal_separator" value="{{ $currency->decimal_separator }}">
                                    </div>
                                </div>
                            </div>
                        </div>

                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="update_customers" {{ old('update_customers') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="delete_purchase_return" {{ old('delete_purchase_return') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="confirm_purchase_deliveries" {{ old('confirm_purchase_deliveries') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="confirm_transfers" {{ old('confirm_transfers') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="confirm_sale_deliveries" {{ old('confirm_sale_deliveries') ? 'checked' : '' }}>

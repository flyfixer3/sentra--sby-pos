                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="manage_defect_types" {{ $role->permissions->contains('name', 'manage_defect_types') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="approve_adjustments" {{ $role->hasPermissionTo('approve_adjustments') ? 'checked' : '' }}>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="access_crm" name="permissions[]" value="access_crm" {{ $role->hasPermissionTo('access_crm') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="access_crm">Masuk CRM</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="view_all_branches" name="permissions[]" value="view_all_branches" {{ $role->hasPermissionTo('view_all_branches') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="view_all_branches">Semua Cabang</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="show_crm_reports" name="permissions[]" value="show_crm_reports" {{ $role->hasPermissionTo('show_crm_reports') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="show_crm_reports">Lihat Laporan</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="manage_crm_permissions" name="permissions[]" value="manage_crm_permissions" {{ $role->hasPermissionTo('manage_crm_permissions') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="create_crm_leads" name="permissions[]" value="create_crm_leads" {{ $role->hasPermissionTo('create_crm_leads') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_crm_leads">Buat</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="show_crm_leads" name="permissions[]" value="show_crm_leads" {{ $role->hasPermissionTo('show_crm_leads') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="show_crm_leads">Lihat</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="edit_crm_leads" name="permissions[]" value="edit_crm_leads" {{ $role->hasPermissionTo('edit_crm_leads') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_crm_leads">Edit</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="delete_crm_leads" name="permissions[]" value="delete_crm_leads" {{ $role->hasPermissionTo('delete_crm_leads') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_crm_leads">Hapus</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="comment_crm_leads" name="permissions[]" value="comment_crm_leads" {{ $role->hasPermissionTo('comment_crm_leads') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="comment_crm_leads">Catatan</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="convert_crm_leads" name="permissions[]" value="convert_crm_leads" {{ $role->hasPermissionTo('convert_crm_leads') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="create_crm_service_orders" name="permissions[]" value="create_crm_service_orders" {{ $role->hasPermissionTo('create_crm_service_orders') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_crm_service_orders">Buat PK</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="show_crm_service_orders" name="permissions[]" value="show_crm_service_orders" {{ $role->hasPermissionTo('show_crm_service_orders') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="show_crm_service_orders">Lihat PK</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="edit_crm_service_orders" name="permissions[]" value="edit_crm_service_orders" {{ $role->hasPermissionTo('edit_crm_service_orders') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="edit_crm_service_orders">Edit PK</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="delete_crm_service_orders" name="permissions[]" value="delete_crm_service_orders" {{ $role->hasPermissionTo('delete_crm_service_orders') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_crm_service_orders">Hapus PK</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="assign_crm_service_orders" name="permissions[]" value="assign_crm_service_orders" {{ $role->hasPermissionTo('assign_crm_service_orders') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-lg-3 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="upload_crm_photos" name="permissions[]" value="upload_crm_photos" {{ $role->hasPermissionTo('upload_crm_photos') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="upload_crm_photos">Upload Foto</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="delete_crm_photos" name="permissions[]" value="delete_crm_photos" {{ $role->hasPermissionTo('delete_crm_photos') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="delete_crm_photos">Hapus Foto</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="show_crm_warranties" name="permissions[]" value="show_crm_warranties" {{ $role->hasPermissionTo('show_crm_warranties') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="show_crm_warranties">Lihat Garansi</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4 col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="upsert_crm_warranties" name="permissions[]" value="upsert_crm_warranties" {{ $role->hasPermissionTo('upsert_crm_warranties') ? 'checked' : '' }}>

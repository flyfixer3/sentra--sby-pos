                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="purchase-order-form"
                              ...
                              data-confirm-message="Please make sure all Purchase Order data is correct before submitting."
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="reference" required readonly value="PO">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <livewire:product-cart-purchase :cartInstance="'purchase_order'"/>
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    Create Purchase Order <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>

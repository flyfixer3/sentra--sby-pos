                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('product-warehouses.update', $warehouse->id) }}" method="POST"
                              ...
                              data-confirm-message="Please make sure all changes are correct before updating this warehouse."
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{ optional($warehouse->branch)->name ?? '-' }}" disabled>
                                <small class="text-muted">Branch cannot be changed from edit to keep warehouse scope safe.</small>
                            </div>

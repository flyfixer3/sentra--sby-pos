                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#categoryCreateModal">
                            Add Racks <i class="bi bi-plus"></i>
                        </button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryCreateModalLabel">Create Rack</h5>
                ...
                <form action="{{ route('product-categories.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="category_code">Rack Code <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="category_code" required>
                        </div>
                        <div class="form-group">
                            <label for="category_name">Rack Name <span class="text-danger">*</span></label>

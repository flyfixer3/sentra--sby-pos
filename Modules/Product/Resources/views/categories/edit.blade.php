...
@section('title', 'Edit Product Racks')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('products.index') }}">Products</a></li>
        <li class="breadcrumb-item"><a href="{{ route('product-categories.index') }}">Racks</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('product-categories.update', $category->id) }}" method="POST"
                              ...
                              data-confirm-message="Please make sure all changes are correct before updating this category."
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold" for="category_code">Rack Code <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="category_code" required value="{{ $category->category_code }}">
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold" for="category_name">Rack Name <span class="text-danger">*</span></label>
